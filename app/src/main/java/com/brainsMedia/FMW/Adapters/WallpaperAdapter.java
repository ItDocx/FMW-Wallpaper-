package com.brainsMedia.FMW.Adapters;
...
import com.brainsMedia.FMW.ShowWallpapers;
...
public class WallpaperAdapter extends RecyclerView.Adapter<WallpaperAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        Glide.with(holder.walpaperImage.getContext()).load(wallpaperList.get(position)).centerCrop().into(holder.walpaperImage);

        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent = new Intent(context, ShowWallpapers.class);
