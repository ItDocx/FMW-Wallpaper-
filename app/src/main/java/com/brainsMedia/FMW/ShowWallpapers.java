...
public class ShowWallpapers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Dialog
        dialog = new Dialog(ShowWallpapers.this);
        dialog.setContentView(R.layout.custom_dialoge);

     /*   // Toolbar Actions
        toolbar = findViewById(R.id.showWallpaper_toolbar);
...
*/
        ...
        // Getting Ad Function
        getBannerAd("https://female-models-wallpapers-default-rtdb.firebaseio.com/banner2");



        // Interstetial Ad

        getInterstetial("https://female-models-wallpapers-default-rtdb.firebaseio.com/Interstetial");
        ...
        apply_Btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mInterstitialAd!=null){
                    ...
                    mInterstitialAd.show(ShowWallpapers.this);
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdFailedToShowFullScreenContent(@NonNull AdError adError) {
                            ...
                            Toast.makeText(ShowWallpapers.this, "Error: "+adError.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
...
// Banner Ad
    ...
    public void getBannerAd(String ad_Id){
        ...
        Firebase.setAndroidContext(ShowWallpapers.this);
        ...
        showAdfireBase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                AdView showBanner = new AdView(ShowWallpapers.this);
    ...
    private void getInterstetial(String ad_Id){
        ...
        interFirebase.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(FirebaseError firebaseError) {
                ...
                Toast.makeText(ShowWallpapers.this, "Error: "+firebaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void setInterstetial(String interstetialId) {
        ...
        mInterstitialAd.load(this, interstetialId, adRequest, new InterstitialAdLoadCallback() {
            ...
            public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                ...
                Toast.makeText(ShowWallpapers.this, "Error: "+loadAdError.getMessage(), Toast.LENGTH_SHORT).show();
            }
